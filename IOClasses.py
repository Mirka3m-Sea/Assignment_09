...
class FileIO:
    ...
    def save_inventory(file_name: list, lst_Inventory: list) -> None:
        ...
        # TO DO modify method to accept a list of file names.
        #I needed to create two different files for the cd and the track. 
        #In CD_Inventory, we are told that 
        #there are two files, thus two different lists too.
        #lstFileNames = ['AlbumInventory.txt', 'TrackInventory.txt']
        #Note: the name file_name_CD is already assigned by the starter script.
        ...
        # TO DO add code to save track data to file
    ...
    def load_inventory(file_name: list) -> list:
        ...
        Returns:
            ...
            Assignment 9 notes: I followed the examples from the class Module (Lab9A).
        ...
        try:
            ...
            # TO DO add code to load track data
            #follow the same steps than loading the CD list.
            with open(file_name_trk,'r') as file:
                for line in file:
                   data = line.strip().split(',')
                   #created variables to append/add.
                   #call form the module ProcessingClasses.py, the class DataProcessor
                   #and the function "select_cd"
